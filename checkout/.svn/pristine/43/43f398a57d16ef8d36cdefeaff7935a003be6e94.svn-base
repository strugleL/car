...
public class LoginController {
    ...
    //登录操作
    @RequestMapping(value = "/collectorLogin",method = RequestMethod.POST)
    @ResponseBody
    public void collectorLogin(HttpServletRequest request, HttpServletResponse response,
                               HttpSession session,
                               @RequestParam("username") String username,
                               @RequestParam("password") String password,
                               @RequestParam("identity") String identity){
        int result = loginService.collectorLogin(username,password,identity);

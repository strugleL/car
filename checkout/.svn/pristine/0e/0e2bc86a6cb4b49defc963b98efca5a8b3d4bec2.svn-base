...
//                }
     ...
     * @return
     */
    public int getOneMonthOperatorFindDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
        //由于数据的时间问题，暂时更改sql查询语句
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='1' and operator = ? and exTime > DATE_SUB(NOW(),INTERVAL 2 MONTH)";
//        String sql = "SELECT COUNT(*) as times from data WHERE action=1";
        try {
            ps = conn.prepareStatement(sql);
...
//                }
     ...
     * @return
     */
    public int getLastMonthOperatorFindDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='1' and operator = ? and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 3 MONTH) and DATE_SUB(NOW(),INTERVAL 2 MONTH)";
//        String sql = "SELECT COUNT(action) as times from data WHERE action=1 and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 3 MONTH) and DATE_SUB(NOW(),INTERVAL 2 MONTH)";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1,operator);
...
//                }
     ...
     * @return
     */
    public int getLastYearMonthOperatorFindDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
//        String sql = "SELECT COUNT(action) as times from data WHERE action=1 and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 15 MONTH) and DATE_SUB(NOW(),INTERVAL 14 MONTH)";
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='1' and operator = ? and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 15 MONTH) and DATE_SUB(NOW(),INTERVAL 14 MONTH)";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1,operator);
            rs = ps.executeQuery();
...
//                }
     ...
     *
     * */
    public int getOneMonthCancelDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
        //由于数据的时间问题，暂时更改sql查询语句
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='2' and operator = ? and exTime > DATE_SUB(NOW(),INTERVAL 2 MONTH)";
//        String sql = "SELECT COUNT(*) as times from data WHERE action=1";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1,operator);
...
//                }
     ...
     * @return
     */
    public int getLastMonthCancelDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='2' and operator = ? and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 3 MONTH) and DATE_SUB(NOW(),INTERVAL 2 MONTH)";
//        String sql = "SELECT COUNT(action) as times from data WHERE action=1 and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 3 MONTH) and DATE_SUB(NOW(),INTERVAL 2 MONTH)";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1,operator);
...
//                }
     ...
     * @return
     */
    public int getLastYearMonthCancelDodgeTimes(String operator) {
        int times = 0;
        Connection conn = dataBaseTool.getConn();
        PreparedStatement ps = null;
        ResultSet rs = null;
//        String sql = "SELECT COUNT(action) as times from data WHERE action=1 and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 15 MONTH) and DATE_SUB(NOW(),INTERVAL 14 MONTH)";
        String sql = "SELECT COUNT(action) as times from auditRes WHERE action='2' and operator = ? and exTime BETWEEN DATE_SUB(NOW(),INTERVAL 15 MONTH) and DATE_SUB(NOW(),INTERVAL 14 MONTH)";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1,operator);
            rs = ps.executeQuery();

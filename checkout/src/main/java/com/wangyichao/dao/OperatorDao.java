...
public class OperatorDao {
    ...
    public int changeInfo(String operator_id, String gender, String birth, String political, String minzu, String phone, String address, String email) {
        ...
        String sql2 = "update tollcollector set gender=?,birth_date=?,political_status=?,minzu=?,phone_number=?,address=?,email=? where operator_id=?";
        try {
                ps = conn.prepareStatement(sql2);
                ps.setString(1,gender);
                ps.setString(2,birth);
                ps.setString(3,political);
                ps.setString(4,minzu);
                ps.setString(5,phone);
                ps.setString(6,address);
                ps.setString(7,email);
                ps.setString(8,operator_id);

...
app.controller("collectCtrl",function($scope, $http, $interval,$timeout){
    ...
    //     console.log("political=",$scope.political);
    //     console.log("prolife.political=",$scope.profile.political);
    //     //判断输入是否为空
    //     if ($scope.gender == undefined || $scope.gender == "" ||
    //         $scope.birth == undefined || $scope.birth == "" ||
    //         $scope.political == undefined || $scope.political == "" ||
    //         $scope.minzu == undefined || $scope.minzu == "" ||
    //         $scope.phone == undefined || $scope.phone == "" ||
    //         $scope.address == undefined || $scope.address == "" ||
    //         $scope.email == undefined || $scope.email == ""){
    //         alert("输入不能为空")
    //     }else{
    //         var url = rootUrl + "operatorController/changeInfo";
    //         $http({
    //             method:"post",
    //             url : url,
    //             params : {
